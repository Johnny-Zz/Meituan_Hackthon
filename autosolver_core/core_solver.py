...
CONFIG = {'time_budget_ms': 7000.0,
 ...
 'strategies': [
   (0.0463, 0.915,  0.0814, 0.0619, 0.052,  0.3189, 0),
   (0.099,  0.9555, 0.0258, 0.1814, 0.0,    0.0747, 0),
   (0.051,  1.0402, 0.0407, 0.3392, 0.1406, 0.0082, 1),
   (0.0696, 1.1396, 0.0974, 0.0701, 0.1129, 0.1305, 0),
   (0.0605, 1.0808, 0.0051, 0.33,   0.1131, 0.0428, 1),
   (0.0285, 1.0402, 0.0407, 0.3415, 0.189,  0.0511, 0),
   (0.02,   0.6,    0.2,    0.3,    0.1,    0.0,    1),
   (0.1,    0.3,    0.05,   0.0,    0.25,   0.15,   0),
   (0.05,   0.8,    0.15,   0.1,    0.0,    0.0,    0),
   (0.03,   0.5,    0.0,    0.4,    0.2,    0.0,    1),
   (0.08,   1.0,    0.1,    0.15,   0.05,   0.1,    0),
   (0.01,   0.4,    0.12,   0.25,   0.15,   0.05,   0),
 ]}
